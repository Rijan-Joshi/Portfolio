...
import { Moon, Sun, Github, Linkedin, Mail, Home, LayoutGrid, BookOpen, FileText } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isDarkMode, toggleTheme, isMobileOpen, closeMobileMenu }) => {
  ...
  return (
    <div className="flex flex-col h-full p-6 lg:p-10 relative overflow-y-auto scrollbar-thin scrollbar-thumb-neutral-200 dark:scrollbar-thumb-neutral-800">
      ...
      <div className="mt-auto pt-6 border-t border-neutral-200 dark:border-neutral-800 flex items-center justify-between">
        <div className="flex gap-4">
          <Tooltip content="GitHub Profile">
            <a href={PERSONAL_INFO.github} target="_blank" rel="noreferrer" className="text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors hover:scale-110 transform duration-200 block">
                <Github size={18} />
            </a>
          </Tooltip>
          <Tooltip content="Send Email">
            <a href={`mailto:${PERSONAL_INFO.email}`} className="text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors hover:scale-110 transform duration-200 block">
                <Mail size={18} />
            </a>
          </Tooltip>
          <Tooltip content="LinkedIn Profile">
            <a href={PERSONAL_INFO.linkedin} target="_blank" rel="noreferrer" className="text-neutral-400 hover:text-neutral-900 dark:hover:text-white transition-colors hover:scale-110 transform duration-200 block">
                <Linkedin size={18} />
            </a>
          </Tooltip>
        </div>
