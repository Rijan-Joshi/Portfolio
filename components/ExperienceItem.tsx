  ...
  return (
    ...
    >
      ...
      <div className="flex-shrink-0">
        <div className="w-14 h-14 rounded-xl bg-neutral-100 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 flex items-center justify-center text-lg font-bold text-neutral-500 dark:text-neutral-400 shadow-sm z-10 relative group-hover:border-primary/50 dark:group-hover:border-blue-500/50 transition-colors">
          {experience.logo || experience.company.substring(0, 2)}
        </div>
      </div>
      ...
      <div className="flex-1 pb-10">
        ...
        <ul className="space-y-3">
          {experience.description.map((item, index) => (
            <li key={index} className="text-neutral-700 dark:text-neutral-300 text-base leading-relaxed">
              • {item}
            </li>
          ))}
        </ul>
