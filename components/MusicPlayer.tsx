...
const TRACKS = [
  {
    title: "Chill Vibes",
    // Standard stable MP3 test files or reliable CDNs
  ...
  },
  {
    ...
    src: "https://music.apple.com/np/song/when-we-feel-young/1710801275"
  }
];
    ...
    <div className="mt-6 p-4 rounded-2xl bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 flex flex-col gap-4 group shadow-sm hover:shadow-md transition-all duration-300">
      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-shrink-0 w-10 h-10 flex items-center justify-center">
            ...
            <div className="relative z-10 flex items-center justify-center gap-0.5 h-full w-full">
                {!isPlaying ? (
                    ...
                    <>
                        <motion.div animate={{ height: [4, 12, 4] }} transition={{ repeat: Infinity, duration: 0.5 }} className="w-0.5 bg-primary dark:bg-blue-400 rounded-full" />
                        <motion.div animate={{ height: [8, 16, 8] }} transition={{ repeat: Infinity, duration: 0.4 }} className="w-0.5 bg-primary dark:bg-blue-400 rounded-full" />
                        <motion.div animate={{ height: [4, 10, 4] }} transition={{ repeat: Infinity, duration: 0.6 }} className="w-0.5 bg-primary dark:bg-blue-400 rounded-full" />
                    </>
                )}
            </div>
        </div>
        ...
        <div className="flex flex-col overflow-hidden">
            <span className="text-[10px] font-bold text-neutral-400 uppercase tracking-wider truncate">Focus Mode</span>
            <motion.span 
