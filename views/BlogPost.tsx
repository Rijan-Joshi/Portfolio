      ...
      <header className="mb-8">
        <div className="flex flex-wrap gap-2 mb-4">
          {blog.tags?.map((tag) => (
            <span
              key={tag}
              className="px-2.5 py-0.5 rounded-full bg-neutral-100 dark:bg-neutral-800 text-xs font-semibold text-neutral-600 dark:text-neutral-300"
            >
              {tag}
            </span>
          ))}
        </div>
        <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-neutral-900 dark:text-white leading-tight mb-4">
          {blog.title}
        </h1>
      ...
      <div className="mb-10 p-4 rounded-lg bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-700/50 flex items-start gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-amber-700 dark:text-amber-400/80 leading-relaxed">
            This is a placeholder blog post for the portfolio. The content below
            is simulated to demonstrate layout and typography.
          </p>
        </div>
      </div>
